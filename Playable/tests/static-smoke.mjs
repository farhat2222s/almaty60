...
if(state.missions.length!==30||state.cars.length!==world.cars.length||state.cars.length<13||!world.canWalk(state.player.position.x,state.player.position.z))throw new Error('unexpected world state');
